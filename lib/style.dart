...
const DashboardBackgroundColor = Color.fromARGB(255, 231, 233, 216);
const CellGreyBackground = Color.fromARGB(255, 248, 248, 248);
...
const BoldMediumSizeTextStyle = TextStyle(
  fontFamily: FontNameDefault,
  fontWeight: FontWeight.w700,
...
const BoldSmallSizeTextStyle = TextStyle(
  fontFamily: FontNameDefault,
  fontWeight: FontWeight.w700,
...
const Regular14SizeTextStyle = TextStyle(
    fontFamily: FontNameDefault,
    fontWeight: FontWeight.w500,
    fontSize: SmallTextSize,
    color: HeadlineColor);

const WhiteHeadlineTextStyle = TextStyle(
  fontFamily: FontNameDefault,
  fontWeight: FontWeight.w700,
  fontSize: LargeTextSize,
  color: Colors.white,
